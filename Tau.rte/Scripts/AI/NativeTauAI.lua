...
function NativeTauAI:Create(Owner)
	local Members = {}
...
function NativeTauAI:Update(Owner)
...
function NativeTauAI:CreateSentryBehavior(Owner)
...
function NativeTauAI:CreateAttackBehavior(Owner)
	self.ReloadTimer:Reset()
	self.TargetLostTimer:Reset()
...
function NativeTauAI:CreateHtHBehavior(Owner)
...
function NativeTauAI:CreateSuppressBehavior(Owner)
	if Owner:EquipFirearm(true) then
...
function NativeTauAI:CreateMoveAroundBehavior(Owner)
...
function NativeTauAI:CreateFaceAlarmBehavior(Owner)
