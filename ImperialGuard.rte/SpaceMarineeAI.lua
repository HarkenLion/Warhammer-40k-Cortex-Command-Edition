...
function Update(self)
	...
	if (self:IsDead() ~= true) then
		...
		imperialguardLines.handleHealth(self);

		imperialguardLines.handleAITargetLogic(self);

		imperialguardLines.handleSuppression(self);
		
	else
	
		imperialguardLines.handleDying(self);
