...
function Create(self)
	...
	self.Turret1 = CreateACrab("Valkyrie Laser Turret", "ImperialGuard.rte")
	MovableMan:AddActor(self.Turret1)
	self.Turret1.Offset = Vector(-20, 41)
	self.Turret2 = CreateACrab("Valkyrie Laser Turret", "ImperialGuard.rte")
	MovableMan:AddActor(self.Turret2)
	self.Turret2.Offset = Vector(20, 41)
...
function Update(self)
	...
	if MovableMan:IsActor(self.Turret1) == true then
		if ToActor(self.Turret1).Team == self.Team then
