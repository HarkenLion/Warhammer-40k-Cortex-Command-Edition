...
function NativeOrkAI:Create(Owner)
	local Members = {}
...
function NativeOrkAI:Update(Owner)
...
function NativeOrkAI:CreateSentryBehavior(Owner)
...
function NativeOrkAI:CreateAttackBehavior(Owner)
	self.ReloadTimer:Reset()
	self.TargetLostTimer:Reset()
	...
	elseif
		...
		and SceneMan:ShortestDistance(Owner.Pos, self.Target.Pos, false).Magnitude < 505
		and (self.Target.Pos.Y - Owner.Pos.Y) > 90
	then
...
function NativeOrkAI:CreateHtHBehavior(Owner)
...
function NativeOrkAI:CreateSuppressBehavior(Owner)
...
function NativeOrkAI:CreateMoveAroundBehavior(Owner)
...
function NativeOrkAI:CreateFaceAlarmBehavior(Owner)
