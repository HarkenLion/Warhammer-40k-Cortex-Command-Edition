...
function NativeDevastatorAI:Create(Owner)
	local Members = {}
...
function NativeDevastatorAI:Update(Owner)
...
function NativeDevastatorAI:CreateSentryBehavior(Owner)
...
function NativeDevastatorAI:CreateAttackBehavior(Owner)
	self.ReloadTimer:Reset()
	self.TargetLostTimer:Reset()
...
function NativeDevastatorAI:CreateHtHBehavior(Owner)
...
function NativeDevastatorAI:CreateSuppressBehavior(Owner)
	if Owner:EquipFirearm(true) then
...
function NativeDevastatorAI:CreateMoveAroundBehavior(Owner)
...
function NativeDevastatorAI:CreateFaceAlarmBehavior(Owner)
